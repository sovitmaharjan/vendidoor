    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('attribute.index') }}" class="waves-effect"><i class="mdi mdi-layers"></i><span> Attribute
                        </span></a>
                </li>

                <li>
                    <a href="{{ route('product.index') }}" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i><span> Product
                        </span></a>
                </li>
